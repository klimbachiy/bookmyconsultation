...
public class AppointmentService {
	...
	public String appointment(Appointment appointment) throws InvalidInputException {
		ValidationUtils.validate(appointment);
		Appointment appointmentExists = appointmentRepository.findByDoctorIdAndTimeSlotAndAppointmentDate(appointment.getDoctorId(), appointment.getTimeSlot(), appointment.getAppointmentDate());
		if(null != appointmentExists){
